...
class TitleGenerator:
    ...
    async def generate_titles(self, video_summary: str) -> List[str]:
        ...
        response = self.openai_client.chat.completions.create(
            ...
            messages=[
                {
                    "role": "system",
                    "content": """You are a viral content expert. Generate 5 engaging titles for the video based on the summary.
                    ...
                    6. Not metion how it is split screen since every video is split screen
                    
                    Format each title on a new line."""
                },
                {
                    "role": "user",
                    "content": f"Generate 5 viral-worthy titles for this video summary: {video_summary}"
                }
            ],
            max_tokens=300
        )
